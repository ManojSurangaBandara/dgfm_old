...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase"> SFHQ Reports for the Year - <?php echo $log_year; ?></h1>
		 ...
		 <form id="form1" name="form1" method="post" action="controller/billcontroller.php?mode=reportdgfm" enctype="multipart/form-data">
...
<script type="text/javascript">
<!--<a href="Reportdgfm.php">DGFM-BSMS</a>
