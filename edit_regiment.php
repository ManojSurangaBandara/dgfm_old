...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				<a href="regiments.php" class="button">&lt;&lt; Back</a>
				<h1>Regiments</h1>
				<div class="breadcrumbs">
                
                <?php /*?><a href="admin_home.php">Home</a> / <a href="regiments.php">Regiments</a> / Update Regiment<?php */?>
		  ...
		  <div class="table">
				...
				?>
		 <form id="form1" name="form1" method="post" action="controller/regiment.controller.php?mode=edit&regiment_id=<?php echo $row[0];?>">
          <table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
                    	
						<th class="full" colspan="2">Create New CES Regiment</th>
					</tr>
					<tr>
					...
					<tr>
                      ...
                      <input type="hidden" name="regiment_id" value='<?php echo $regiment_id;?>' />
