...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				<a href="projects.php?status=1&branch_id=6" class="button"><< Back</a>
				<h1>Unsettle Bills</h1>
		  ...
		  <div class="table">
				...
				?>
<form id="form1" name="form1" method="post" action="controller/projects.controller.php?mode=UnsettlenowSfhq&projectid=<?php echo $project_id; ?>&branch_id=<?php echo $branch_id; ?>&sfhq_id=<?php echo $sfhq_id; ?>">
          ...
          <tr class="bg" >
            ...
            <tr class="bg">
                ...
                <tr class="bg">
                     ...
                     <td width="569" class="last">
						<label>
						 <input type="text" disabled="disabled" style="width:400px" value="<?php echo $row[10]; ?> " name="payee_no" id="payee_no" />
					    </label>
					   </td>
                    </tr>
              ...
              <tr class="bg">
                      <td class="first"><strong>Supplier Address</strong></td>
                    	<td width="569" class="last">
						<label>
						 <textarea disabled="disabled" name="sup_addrs" cols="50" rows="1" class="textArea" id="sup_addrs"><?php echo $row[20]; ?> </textarea>                    
            ...
            <tr class="bg">
                      <td class="first"><strong>VAT No</strong></td>
                    	<td width="569" class="last">
						<label>
						 <input type="text" disabled="disabled" value="<?php echo $row[21]; ?> " name="vat_no" id="vat_no" />
					    </label>
					  </td>
           </tr>
           ...
           <tr class="bg" >
					  ...
					  <td class="last">
					    <label>
					      <textarea disabled="disabled" name="remarks" cols="50" rows="2" class="textArea" id="remarks"><?php echo $row[6]; ?> </textarea>
				      </label>
				      </td>
		    </tr>	
