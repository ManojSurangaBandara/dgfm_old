				...
				<td class="last">&nbsp;</td>
                 ...
                 <td> <strong> From </strong> </td>
                    ...
                    <td> <strong> To </strong> </td>
                          <td> <span id="sprytextfield2">
                        <label>
                          <input class="textBoxces dateinput" id="to_period" name="to_period" type="text" title="Minimum date allowed is '1000-01-01'"  pattern="(1[0-9]{3}|20[0-9]{2})-(0[1-9]|1[0-2])-([0-2][1-9]|3[0-1]|10|20)" placeholder="YYYY-MM-DD">
                        </label>
                        </td>
              </table>
