	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				...
				<h1>Return Bills for the Year of <?php echo $_SESSION['log_year']; ?> </h1>
				<div class="breadcrumbs">
                
                <?php /*?><a href="Chiefacc.php?branch_id=<?php echo $branch_id; ?>">Home</a> / Return Voucher<?php */?>  
		  ...
		  <div class="table">
				...
				?>
	<form id="form1" name="form1" method="post" action="controller/projects.controller.php?mode=Returnnowbiguser&projectid=<?php echo $project_id; ?>&cval=<?php echo $status; ?>&branch_id=<?php echo $branch_id; ?>">
            ...
            <tr class="bg">
             ...
             <tr class="bg">
                      <td class="first"><strong>Supplier Address</strong></td>
                    	<td width="569" class="last">
						<label>
						 <textarea disabled="disabled" name="sup_addrs" cols="80" rows="1" class="textArea" id="sup_addrs"><?php echo $row[17]." ".$row[21]." ".$row[22]." ".$row[23]; ?> </textarea>                    
        ...
        <tr class="bg">
            ...
            <tr>
				...
				$result = ProjectsProgress :: GetBillAmountandVotes($project_id,$row[1]);
             	...
             	<tr >
                    ...
                    <?php if($status=='cancel') {  ?>
					  <td class="first"><strong>Return Voucher</strong></td>
                      <td class="last"><label>
             ...
             <tr class="bg">
					  <td class="first">&nbsp;</td>
					  <td class="last"><input type="hidden" name="hiddenField" value="<?php echo $row[13]; ?> " id="hiddenField" /></td>
		    </tr>
