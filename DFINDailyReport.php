...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase">Dte of Fin Daily Report  <?php echo $_SESSION['log_year']; ?></h1>
		 ...
		 <form action="excel/excel_dailyreport.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td ><strong>Report Type</strong></td>
					     <td><label>             
<select name="billstatus"  id="billstatus"  style="width:120px;" >
              <option value="0">NOT SETTLE</option>
              ...
              <option value="4">ALL</option>
                    ...
                    <tr class="bg" >
					  <td valign="top" class="first"><strong>From </strong></td>
                    ...
                    <tr>
					    	  <td valign="top" class="first"><strong>To </strong></td>
					  <td >
                    ...
                    <tr>
						<td ><strong>Supplier Type</strong></td>
					     <td><label>
                         <select name="sup_type"  id="sup_type"  style="width:120px;" >
                          <option value="2">All</option>
                          <option value="1">Vehicle Only</option>  
                          <option value="0">Not a Vehicle</option>
                 ...
                 <select name="vttype" style="width:250px"  id="vttype" >
                  <option value="0">All</option>
                   ...
                   <?php } ?>
                     ...
                     <tr>
						<td ><strong>Vote & Supplier Type</strong></td>
					     <td><label>
                         <select name="trans_vote"  id="trans_vote"  style="width:250px;" >
                          <option value="0">All</option>
                          <option value="1">Remove Transferable Votes & Supplier</option>  
