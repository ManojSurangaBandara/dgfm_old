...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
		 ...
		 <form action="excel/excel_DirSummery.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td ><strong>Directorate Name</strong></td>
					     <td><label><select name="branch_id" class="ComboBoxcesSmall" id="branch_id" style="width:100px;">
						   
							 <?php 
							if($sfhq_id > 0)
							{
							$esrunit = Projects::get_all_branchestosfhqnotall($sfhq_id);
							}
							else
							{							 
