...
$progressdata = Common :: GetSFHQBillDetailsToPSOView($billId,$user_type_id);
  ...
  <tr>
    ...
    <table width="100%" border="0">
     <tr>
        ...
        <td><strong>:</strong></td>
        <td style="font-size:14px"><?php echo $progressdata['Name']; ?></td>
      </tr>
...
<table class="listing" cellpadding="0" cellspacing="0">   
 			...
 			<tr>
					...
					<th width="140" >Vote Code</th>
                    <th width="428" >Vote Name</th>
			 ...
			 $result = ProjectsProgress :: GetBillAmountandVotesToSfhq($billId,$progressdata['Bill_No']);
             	...
             	<tr >
					  ...
					  <td colspan="3" class="first" align="center"><strong > &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Total</strong></td>
