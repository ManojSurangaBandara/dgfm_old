...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				<a href="new_ge_unit.php" class="button">ADD NEW </a>
				<h1>ESS</h1>
				<div class="breadcrumbs">
                
             <?php /*?>   <a href="admin_home.php">Home</a> / ESS<?php */?>
           ...
           <td>
             <table width="100%" border="0">
               <tr>
                 <td width="13%">Select CES Unit</td>
                 <td width="27%"><label>         
            <label>
<select name="esr_unit" class="ComboBoxcesSmall" style="width:70px;" id="esr_unit" onchange="getEsrUnitIDGE(this.value)">
		...
		{					
			...
			<div class="table">
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
						<th class="first" width="38">No</th>
						<th width="228"><span class="first">ESS Name</span></th>
						<th width="108">Location</th>
					<!--	<th width="82">Unit</th>-->
						<th width="202">Description</th>
						<th width="42">Edit</th>
						<th width="48" class="last">Delete</th>
				  </tr>
                  <?php 
					...
					<tr>
						...
						<td><a href="new_ge_unit.php?geid=<?php echo $row[0]; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="" /></a></td>
						<td class="last"><a onclick="deletegebranch('<?php echo $row[0];?>');" href="#" ><img src="images/hr.gif" width="16" height="16" alt="Delete" /></a></td>
					</tr>
                     <?php 
					 $i +=1;
					 } ?>
	...
	?>	
		...
		<tr><td align="right">
			<?php
				...
				?>
				<a href="ge_branch.php?&page=<?php echo($page_id - 1); ?>&unitid=<?php echo "$unit_id"; ?>&projectID=<?php echo $project_id; ?>&max=<?php echo($max_rec); ?>">&laquo; Previous</a> | <?php } ?>
				<?php echo((($page_id * $limit) + 1));?> - <?php echo((($page_id * $limit) + $num_rows)); ?> of <?php echo($max_rec); ?>
				<?php if ((($page_id * $limit) + $limit) < $max_rec) { ?>
				| <a href="ge_branch.php?page=<?php echo($page_id + 1); ?>&projectID=<?php echo $project_id; ?>&max=<?php echo($max_rec)?>&unitid=<?php echo "$unit_id"; ?>">Next &raquo</a>
