<?php
	...
	$today = date("m.d.y");	
	$excel=new ExcelWriter($sfhq_id."VoteBalance_Report.xls");	
	...
	//	}
		...
		$myArrtitle=array("<strong> STATEMENT OF VOTE BALANCES AS AT ". $txt_as_at_date." </strong>");
		...
		$esrunit = Projects :: GetVoteBalanceforSfhq($txt_as_at_date);	
...
/*		
	...
	$document =$sfhq_id."VoteBalance_Report.xls"; 	
	$fp = fopen($document, 'r');   
