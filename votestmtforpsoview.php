...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase"> Vote Statement Report - <?php echo $Branch['branch_name']; ?> - <?php echo $_SESSION['log_year']; ?> </h1>
		 ...
		 <form action="excel/psovotestatement.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
