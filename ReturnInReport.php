...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1>Return In Report for the Year of  - <?php echo $_SESSION['log_year']; ?></h1>
		 ...
		 <form action="excel/excelreturnin.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
					    	  <td valign="top" class="first"><strong>Return In To </strong></td>
					  <td >
