...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
		 ...
		 <form id="form1" name="form1" method="post" action="controller/billcontroller.php?mode=savebigUser&user_type_id=<?php echo $user_type_id;?>&user_id=<?php echo $user_id; ?>" enctype="multipart/form-data">
                    ...
                    <tr class="bg">
                      ...
                      <td class="last">
                        <table width="100%" border="0">
                          <tr>
                            <td width="23%"><select name="brach_id" class="ComboBoxcesSmall" id="brach_id"   style="width:100px;" onchange="showbranchestochiefacc(this.value)" >
          ...
          <tr class="bg">
				 <td width="144" height="26" class="first"><strong>Invoice Details </strong></td>
				 <td width="596" class="last">
           ...
           <tr class="bg">
                      ...
                      <td width="596"><select name="Payee_name" id="Payee_name" style="width:500px;">
	...
	<td class="last">
    <label>
	<input type="text" name="vote_name2"  id="vote_name2" style="width:430px" value="<?php echo $_GET['votename2']; ?>" />
	</label>
    </td>
	...
	<td class="last">
    <label>
	<input type="text" name="vote_name3"  id="vote_name3" style="width:430px" value="<?php echo $_GET['votename3']; ?>" />
	</label>
    </td>
