...
$brach_id	=	isset( $_GET['brach_id'])?$_GET['brach_id']:59;
...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
			  <a href="displaymoneyallocation.php" class="button">&lt;&lt; Back </a>
	            <h1>Money Allocation for the Votes</h1>
		 ...
		 <form id="form1" name="form1" method="post" action="controller/money.controller.php?mode=save">
