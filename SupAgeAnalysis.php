...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1>Supplier Age Analysis Outstanding for the Year of - <?php echo $_SESSION['log_year']; ?> </h1>
		 ...
		 <form action="excel/excel_supAgeAnalysis.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
