...
$brach_id   = isset( $_GET['brach_id'])?$_GET['brach_id']:1;
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				...
				<div class="breadcrumbs"><?php /*?><a href="projects.php">Home</a>/ New Bill Details<?php */?></div>
			</div><br />
		  ...
		  <div class="table">
				...
				?>               								   
		 <form id="form1" name="form1" method="post" action="controller/billcontroller.php?mode=save&sfhq_id=<?php echo $sfhq_id;?>" enctype="multipart/form-data">
          <table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
                    	
						<th class="full" colspan="2">Add New Bill Details</th>
...
<tr >
           ...
           <tr class="bg" >
                        ...
                        <label>
                          <input name="txtstart_date" type="date" required="" class="textBoxces" id="txtstart_date"  />
                        </label>
                        </td>
					</tr>			
...
<tr >
                        ...
                        <label>
                          <input type="text" name="txt_bill_amount" id="txt_bill_amount" />
                        </label>
           ...
           <tr class="bg" >
					  ...
					  <td class="last">
					    <label>
					      <textarea name="remarks" cols="50" rows="5" class="textArea" id="remarks"></textarea>
				      </label>
				      </td>
		    </tr>			 
            
            <tr >
					  <td valign="top" class="first"><strong>Upload the Bill</strong></td>
					  <td class="last"><label>
