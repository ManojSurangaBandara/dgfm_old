                   ...
                   <span class="textfieldRequiredMsg">*</span>   </label>
                    ...
                    <tr class="bg">
						...
						<td class="last"><span id="sprytextfield6">
						  <label>
						   <b> +94 </b><input type="text" pattern="^7[0|1|2|4|5|6|7|8]\d{7}$" title="Nine numbers with leading 7. No zero at the beginning. Mbile numbers only."  max="999999999" min="700000000" name="mobile" id="mobile" value="<?php echo $row[8]; ?>" /> <span class="textfieldRequiredMsg">*</span>
					    </label>
					   </span>
					   <b>Ex :- 711231234</b>
					   </td>
                     ...
                     <tr class="bg">
						...
						<td class="last">
						  <label>
						    <b> +94 </b><input type="text" pattern="^((11|21|23|24|25|26|27|31|32|33|34|35|36|37|38|41|45|47|51|52|54|55|57|63|65|66|67|81|91)(0|2|3|4|5|7|9)|7(0|1|2|4|5|6|7|8)\d)\d{6}$" title="Nine numbers. No zero at the beginning. Mobile or landline numbers" max="999999999"  min="100000000"  name="contactNo" id="contactNo" value="<?php echo $row[3]; ?>" /> </label>
