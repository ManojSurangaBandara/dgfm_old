	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				...
				<h1>ENTER CHECK DETAILS & PRINT -  <?php echo $_SESSION['log_year']; ?> </h1>
		  ...
		  <div class="table">
				...
				?>
	<form id="form1" name="form1" method="post" action="controller/projects.controller.php?mode=checkdetails&projectid=<?php echo $project_id; ?>&branch_id=<?php echo $branch_id; ?>">
       ...
       <tr class="bg">
                      <td class="first"><strong>Cheque Number</strong></td>
                   	  <td  class="last">&nbsp;
						<label>
						     <input type="text" name="cheque_no" id="cheque_no" value="<?php echo $row[19]; ?> " />
					    </label></td>
          			 </tr>
                      ...
                      <td class="first"><strong>File Reference </strong></td>
                   	  <td  class="last">&nbsp;
						<label>
						     <input style="width:350px" type="text"  name="file_ref" id="file_ref" value="<?php echo $row[24]; ?> "/>
					    </label></td>
          			 </tr>
