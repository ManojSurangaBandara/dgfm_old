	...
	<div id="middle">
		...
		<div id="center-column">
		  ...
		  <div class="table">
				...
				?>
	<form id="form1" name="form1" method="post" action="controller/projects.controller.php?mode=Returnnowsfhq&projectid=<?php echo $project_id; ?>&cval=<?php echo $status; ?>&branch_id=<?php echo $branch_id; ?>">
				...
				$result = ProjectsProgress :: GetBillAmountandVotesToSfhq($project_id,$row[1]);
             	...
             	<tr >
                    ...
                    <?php if($status=='cancel') {  ?>
                     ...
                     <tr>
                     <td><strong>Reason for Returned</strong></td>
                     
                     <td>
                     
                       <label>
					      <textarea name="rtnreason" cols="50" rows="1" class="textArea" id="rtnreason"></textarea>
				      </label>
                     ...
                     <td>
                       <label>
					      <textarea name="rtnreason"  disabled="disabled" cols="50" rows="5" class="textArea" id="rtnreason"><?php echo $row[12]; ?> </textarea>
				      </label></td>
                      <?php }  ?>
