	...
	<div id="middle">
		...
		<div id="center-column">
		  ...
		  <div class="table">
				...
				?>
		 <form id="form1" name="form1" method="post" action="controller/projects.controller.php?mode=cancelBiguser&projectid=<?php echo $project_id; ?>&cval=<?php echo $status; ?>">
          <table class="listing form" cellpadding="0" cellspacing="0">
           ...
           <tr class="bg" >
                        ...
                        <label>
                          <input disabled="disabled" value="<?php echo $row[3]; ?> " name="txtstart_date" type="date" required="" class="textBoxces" id="txtstart_date"  />
                        </label>
                        </td>
					</tr>			
           ...
           <tr class="bg" >
                        ...
                        <label>
                          <input disabled="disabled" value="<?php echo $row[4]; ?> " name="invoice_date" type="date" required="" class="textBoxces" id="invoice_date"  />
                        </label>
                        </td>
					</tr>	 
