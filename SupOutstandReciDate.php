...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase"><?php echo $sfhq_name ?? "Directorate of Finance" ; ?> -Suppliers Report - <?php echo $_SESSION['log_year']; ?>   </h1>
		  ...
		  <div class="table">
            ...
            <?php  if($sfhq_id >0){   ?>
		 <form action="excel/Supageanyforacc.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
         <?php } else {?>
         
         <form action="excel/excelSupOutstd.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
         <?php } ?>
         
          <table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
                    	
						<th class="full" colspan="2">Suppliers Report</th>
					</tr>
...
<select name="sup_id"  id="sup_id" style="width:220px;">
           ...
           <tr class="bg">
					  ...
					  <td class="last">&nbsp;&nbsp;<select name="rtptype" class="ComboBoxcesSmall" id="rtptype"  style="width:115px;" >
