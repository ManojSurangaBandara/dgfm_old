...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				 <a href="DirstributetoSFHQLevel.php" class="button">&lt;&lt; Back </a>
				<h1>Allocation For the Year of <?php echo $year_r; ?> </h1>
 ...
 <option value="<?php echo $i; ?>" <?php if( $i == $year_r ){ echo "selected=selected"; }?>><?php echo $i; ?></option>
                      ...
                      <td width="18%" class="first"><strong>Operational Controller</strong></td>
                            ...
                            <td class="last" style="dis">     <select name="branch_id" class="ComboBoxcesSmall" id="branch_id"   style="width:80px;">
...
<?php 
	...
	if (!$max_rec) 
		{					
			$result = Money :: getSFHQLevleAllocationDetails($year_r,$branch_id);
			if (!$result) return;
			...
			$max_rec = mysql_num_rows($result);
				...
				$result = Money :: getSFHQLevelAllocationDetailsPagination($year_r,$branch_id,$current1, $length);				
				if (!$result) return;			
				...
				<table class="listing" cellpadding="0" cellspacing="0">
					<tr>
                        ...
                        <th width="200">Vote</th>	
                         <th width="100">Account Office</th>				
                  ...
                  <?php 
					...
					<?php /*?>	<td align="left"><?php echo $row[1]; ?></td><?php */?>
						...
						<td><a href="EditOpsConlevelAllocation.php?allocationid=<?php echo $row[0]; ?>&brach_id=<?php echo $branch_id; ?>"><img src="images/edit-icon.gif" width="16" height="16" alt="" /></a></td>
	...
	?>	
		...
		<tr><td align="right">
			<?php
				...
				?>
				<a href="EditSFHQLevelAllocation.php?&page=<?php echo($page_id - 1); ?>&max=<?php echo($max_rec); ?>">&laquo; Previous</a> | <?php } ?>
				<?php echo((($page_id * $limit) + 1));?> - <?php echo((($page_id * $limit) + $num_rows)); ?> of <?php echo($max_rec); ?>
				<?php if ((($page_id * $limit) + $limit) < $max_rec) { ?>
				| <a href="EditSFHQLevelAllocation.php?page=<?php echo($page_id + 1); ?>&max=<?php echo($max_rec)?>">Next &raquo</a>
