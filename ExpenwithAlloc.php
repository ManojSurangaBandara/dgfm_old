...
<script language="JavaScript" type="text/JavaScript" src="js/niceforms.js"></script></head>
<body>
<div id="main">
	<div id="header">
	...
	<div id="middle">
		...
		<!--<a href="#" class="link"> Bar Charts</a>-->		
		</div>
		<div id="center-column">
			<div class="top-bar">

         
	      <h1>Allocation and Expenditure Chart</h1>
		 ...
		 <form action="FusionCharts/Gallery/MSColumn3D.php?years=<?php echo $log_year;?>" method="post"  name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
                  ...
                  <tr>                    	
                   ...
                   <tr class="bg" >
					  <td valign="top" class="first"><strong>Year</strong></td>
				    <td > <strong>  <?php  echo $log_year ;  ?></strong></td>
		   		 </tr>
