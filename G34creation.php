...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase">Supplier Outstanding In Lieu Of G34 - <?php echo $_SESSION['log_year'];  ?></h1>
		 ...
		 <form action="excel/G34Creationexcel.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
