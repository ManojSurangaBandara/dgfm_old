...
$from 	= isset($_POST['txt_as_at_date'])?$_POST['txt_as_at_date']: $fromdate;
$to 	= isset($_POST['txt_to_date'])?$_POST['txt_to_date']:$todate;
...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
		 ...
		 <form action="excel/excelVoteOutStnd.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
                    	
						<th class="full" colspan="2">Votes Out Standing  Report</th>
					</tr>
                    
                        
		<tr>
						<td ><strong>Select Vote</strong></td>
					     <td><label>         
