...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase">Vote Age Analysis Report <?php echo $_SESSION['log_year']; ?> </h1>
		 ...
		 <form action="excel/excel_Agefordir.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
          <table class="listing form" cellpadding="0" cellspacing="0">
              ...
              <option value="4" >Outstanding</option>
                    ...
                    <tr class="bg">
					  ...
					  <td valign="top" class="first"><strong>Group</strong></td>
					  <td class="last">  <select name="group" class="ComboBoxcesSmall" id="group"  style="width:140px;" >
              <option value="0" >All</option>
              <option value="1" >Dte of Fin</option>    
              <option value="2" >Reg Acct Office</option>             
            </select></td>
