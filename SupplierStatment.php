...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
	      ...
	      <h1 style="text-transform:uppercase"><?php echo $sfhq_name ; ?> - Supplier Statement Report - <?php echo $_SESSION['log_year']; ?>   </h1>
...
<select name="sup_id"  id="sup_id" style="width:450px;">
