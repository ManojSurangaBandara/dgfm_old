	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
             ...
             <?php /*?>   <a href="admin_home.php">Home</a> / <a href="units.php">Units</a> / New Unit<?php */?>
		  ...
		  <div class="table">
				...
				?>
		 <form id="form1" name="form1" method="post" action="controller/unit.controller.php?mode=save&unitid=<?php echo $row[0];?>">
          <table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
                    	
						<th class="full" colspan="2">Create New ESR Unit</th>
					</tr>
					<tr>
						<td class="first" width="172"><strong>Unit Name</strong></td>
					  <td class="last"><span id="sprytextfield1">
					    <label>
                          <input name="unit_name" type="text" class="textBoxces" id="unit_name" size="45" value="<?php echo $row[1]; ?>" />
					...
					<tr class="bg">
						...
						<td class="last"><span id="sprytextfield2">
						  <label>
                            <input name="location" type="text" class="textBoxces" id="location" size="45" value="<?php echo $row[2]; ?>" />
                        <span class="textfieldRequiredMsg">*</span></label>
</span></td>
					</tr>
					<tr>
						<td class="first"><strong>Force Type</strong></td>
						<td class="last"><span id="spryselect1">
						  <label>
						    <select name="force_type" class="textBoxces" id="force_type">
						     <option value=""></option>
							 <?php 
					...
					<tr class="bg">
						...
						<td class="last">
						  <textarea name="txtdescription" id="txtdescription" cols="49" rows="5" class="textArea"><?php echo $row[4]; ?></textarea>
				      </td>
					</tr>
					<tr>
					  <td class="first">&nbsp;</td>
