...
<div id="main">
	...
	<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				<a href="ChiefAccAddbills.php?brach_id=59" class="button">ADD NEW </a>
				...
				<table class="listing" cellpadding="0" cellspacing="0">
                 ...
                 <?php }?>  
                    ...
                    <?php /*?>   <td><?php echo $row[6]; ?></td><?php */?>
						...
						if($status==0)
						{ ?>
                        <td><a href="EditBigUserBill.php?projectid=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>"><img src="images/edit-icon2.gif" width="16" height="16" alt="" /></a></td>
						
             <?php /*?>           <td><a href="CancelBigUserBill.php?projectid=<?php echo $row[0]; ?>&branch_id=<?php echo $branch_id; ?>&cval=cancel"><img src="images/Cancel.ico" width="16" height="16" alt="" /></a></td>
                        <?php */?>
					<?php /*?>	<td ><a onclick="deleteprojectsBigUser('<?php echo $row[0];?>','<?php echo $row[1];?>');" href="#" ><img src="images/hr.gif" width="16" height="16" alt="Delete" /></a></td><?php */?>
                      ...
                      <?php /*?>    <td><a href="#" onclick="RTNbillofBigUser('<?php echo $row[0];?>','<?php echo $user_id ?>');"><img src="images/undo.gif" width="16" height="16" alt="" /></a></td><?php */?>
                          ...
                          <td><a href="Returnbill.php?projectid=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>&cval=cancel"><img src="images/undo.ico" width="16" height="16" alt="" /></a></td>
                        ...
                        <td><a href="#" onclick="settlebillofBigUser('<?php echo $row[0];?>','<?php echo $user_id; ?>','<?php echo $row[11]; ?>');"><img src="images/settle.ico" width="16" height="16" alt="" /></a></td>
				  ...
				  <?php }
						...
						{ ?>
                         ...
                         <td class="last"><a href="UnSettleDFBills.php?billId=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>" class="link"><img src="images/settle.ico" width="16" height="16" alt="" /></a></td>
                                            
                        <?php /*?> <td><a href="#" onclick="unsettlebillofBigUser('<?php echo $row[0];?>','<?php echo $user_id; ?>','<?php echo $row[11]; ?>');"><img src="images/settle.ico" width="16" height="16" alt="" /></a></td><?php */?>
				  ...
				  <?php }
						...
						if($status==2)
						{ ?>
							<?php /*?><td><a href="CancelBigUserBill.php?projectid=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>&cval=active"><img src="images/Button-Reload.ico" width="16" height="16" alt="" /></a></td><?php */?>
                            
							<?php /*?><td ><a onclick="deleteprojectsBigUser('<?php echo $row[0];?>','<?php echo $row[1];?>');" href="#" ><img src="images/hr.gif" width="16" height="16" alt="Delete" /></a></td><?php */?>
                            
                             <?php /*?><td class="last"><a href="ViewBigUserBillDetails.php?billId=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>&status=<?php echo $status; ?>" class="link"><img src="images/Play-Normal.ico" width="16" height="16" alt="" /></a></td><?php */?>
				  <?php }
						...
						{ ?>
							...
							<td><a href="Returnbill.php?projectid=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>&cval=active"><img src="images/undo.ico" width="16" height="16" alt="" /></a></td>
                            
                            
                            
                             <td width="35" class="last"><a href="ViewBigUserBillDetails.php?billId=<?php echo $row[0]; ?>&branch_id=<?php echo $row[11]; ?>&status=<?php echo $status; ?>" class="link"><img src="images/Play-Normal.ico" width="16" height="16" alt="" /></a></td>
                             
                         
	<td width="29" ><a onclick="deleteprojectsBigUser('<?php echo $row[0];?>','<?php echo $row[1];?>');" href="#" ><img src="images/hr.gif" width="16" height="16" alt="Delete" /></a></td>
				  ...
				  <?php }
						...
						{ ?>
                         ...
                         <td><?php echo $row[8]; ?></td>			
                         <td class="last"><a href="ViewBigUserBillDetails.php?billId=<?php echo $row[0]; ?>&branch_id=<?php echo $branch_id; ?>&status=<?php echo $status; ?>" class="link"><img src="images/Play-Normal.ico" width="16" height="16" alt="" /></a></td>
                         
                         <td class="last"><a href="printcheck.php?billId=<?php echo $row[0]; ?>&branch_id=<?php echo $branch_id; ?>" class="link"><img src="images/print.png" width="16" height="16" alt="" /></a></td>
	...
	?>	
		...
		<tr><td align="right">
			<?php
				...
				?>
				<a href="Chiefacc.php?&page=<?php echo($page_id - 1); ?>&branch_id=<?php echo $branch_id; ?>&status=<?php echo $status; ?>&projectID=<?php echo $project_id; ?>&max=<?php echo($max_rec); ?>">&laquo; Previous</a> | <?php } ?>
				<?php echo((($page_id * $limit) + 1));?> - <?php echo((($page_id * $limit) + $num_rows)); ?> of <?php echo($max_rec); ?>
				<?php if ((($page_id * $limit) + $limit) < $max_rec) { ?>
				| <a href="Chiefacc.php?page=<?php echo($page_id + 1); ?>&branch_id=<?php echo $branch_id; ?>&status=<?php echo $status; ?>&max=<?php echo($max_rec)?>">Next &raquo</a>
